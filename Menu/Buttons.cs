    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] // Room Mods [6]
            {
                ...
                new ButtonInfo { buttonText = "Auto Join Room \"PIXEL\"", method =() => Important.QueueRoom("PIXEL"), isTogglable = false, toolTip = "Automatically attempts to connect to room \"PIXEL\" every couple of seconds until connected." },
            ...
            new[] // Admin-Command Blocker Settings [52]
            {
                ...
                new ButtonInfo { buttonText = "confirmusing", overlapText = "Confirm Using", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("confirmusing"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("confirmusing"), toolTip = "Adds the Confirm Using Admin-Command to the List of Allowed Commands." },

                new ButtonInfo { buttonText = "kick", overlapText = "Kick Player", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("kick"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("kick"), toolTip = "Adds the Kick Player Admin-Command to the List of Allowed Commands." },
                new ButtonInfo { buttonText = "silkick", overlapText = "Silent Kick", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("silkick"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("silkick"), toolTip = "Adds the Silent Kick Admin-Command to the List of Allowed Commands." },
                new ButtonInfo { buttonText = "join", overlapText = "Join Room", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("join"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("join"), toolTip = "Adds the Join Room Admin-Command to the List of Allowed Commands." },
                new ButtonInfo { buttonText = "kickall", overlapText = "Kick All Players", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("kickall"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("kickall"), toolTip = "Adds the Kick All Players Admin-Command to the List of Allowed Commands." },
                ...
                new ButtonInfo { buttonText = "vel", overlapText = "Set Velocity", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("vel"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("vel"), toolTip = "Adds the Set Velocity Admin-Command to the List of Allowed Commands." },
                new ButtonInfo { buttonText = "controller", overlapText = "Simulate Controller Input", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("controller"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("controller"), toolTip = "Adds the Simulate Controller Input Admin-Command to the List of Allowed Commands." },
                new ButtonInfo { buttonText = "smoothtp", overlapText = "Smooth Teleport", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("smoothtp"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("smoothtp"), toolTip = "Adds the Smooth Teleport Alt Admin-Command to the List of Allowed Commands." },
                ...
                new ButtonInfo { buttonText = "laser", overlapText = "Laser Effect", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("laser"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("laser"), toolTip = "Adds the Laser Effect Admin-Command to the List of Allowed Commands." },
                new ButtonInfo { buttonText = "notify", overlapText = "Send Notification", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("notify"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("notify"), toolTip = "Adds the Send Notification Admin-Command to the List of Allowed Commands." },
                new ButtonInfo { buttonText = "lr", overlapText = "Draw Line", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("lr"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("lr"), toolTip = "Adds the Draw Line Admin-Command to the List of Allowed Commands." },
                new ButtonInfo { buttonText = "platf", overlapText = "Spawn Platform", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("platf"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("platf"), toolTip = "Adds the Spawn Platform Admin-Command to the List of Allowed Commands." },
                new ButtonInfo { buttonText = "muteall", overlapText = "Mute All", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("muteall"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("muteall"), toolTip = "Adds the Mute All Admin-Command to the List of Allowed Commands." },
                new ButtonInfo { buttonText = "unmuteall", overlapText = "Un-Mute All", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("unmuteall"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("unmuteall"), toolTip = "Adds the Un-Mute All Admin-Command to the List of Allowed Commands." },
                new ButtonInfo { buttonText = "mute", overlapText = "Mute Player", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("mute"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("mute"), toolTip = "Adds the Mute Player Admin-Command to the List of Allowed Commands." },
                new ButtonInfo { buttonText = "unmute", overlapText = "Un-Mute Player", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("unmute"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("unmute"), toolTip = "Adds the Un-Mute Player Admin-Command to the List of Allowed Commands." },
                new ButtonInfo { buttonText = "rigposition", overlapText = "Force Set Rig Position", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("rigposition"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("rigposition"), toolTip = "Adds the Force Set Rig Position Admin-Command to the List of Allowed Commands." },
                new ButtonInfo { buttonText = "sb", overlapText = "Sound Broadcast", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("sb"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("sb"), toolTip = "Adds the Sound Broadcast Admin-Command to the List of Allowed Commands." },
                new ButtonInfo { buttonText = "time", overlapText = "Set Time", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("time"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("time"), toolTip = "Adds the Set Time Admin-Command to the List of Allowed Commands." },
                new ButtonInfo { buttonText = "weather", overlapText = "Weather Toggle", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("weather"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("weather"), toolTip = "Adds the Weather Toggle Admin-Command to the List of Allowed Commands." },
                new ButtonInfo { buttonText = "setfog", overlapText = "Set Fog", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("setfog"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("setfog"), toolTip = "Adds the Set Fog Admin-Command to the List of Allowed Commands." },
