    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] // Admin-Command Blocker Settings [52]
            {
                ...
                new ButtonInfo { buttonText = "isusing", overlapText = "Check Using", hideInArraylist = true, enableMethod = () => AdminPermissionManager.AddCommandToList("isusing"), disableMethod = () => AdminPermissionManager.RemoveCommandFromList("isusing"), toolTip = "Adds the Check Using Admin-Command to the List of Allowed Commands." },
